...
$(document).ready(function(e){
    $("#button1").click(function(){
        document.getElementById("hidbtn1").value=document.getElementById("button1").value;
    });
    $("#button2").click(function(){
        document.getElementById("hidbtn2").value=document.getElementById("button2").value;
    });
    $("#button3").click(function(){
        document.getElementById("hidbtn3").value=document.getElementById("button3").value;
    });
});
